  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-content">
        <header className="topbar"><button className="mobile-menu" onClick={() => setMobileNav(true)} aria-label="Abrir menu"><Menu /></button><div><span className="eyebrow">TERÇA, 11 DE SETEMBRO</span><h1>{view === 'dashboard' ? 'Visão geral' : 'Acervo de livros'}</h1></div><div className="topbar-actions"><button className="icon-button" aria-label="Perfil"><CircleUserRound /></button></div></header>
